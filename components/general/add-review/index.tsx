...
const AddReview = ({ name, avatar }) => {
  return (
    <div className={styles.add_review}>
      <h3>Write Review</h3>
      <p>You are almost out of coins. Tell us about your <br /> experience and earn coins instantly.</p>
      ...
      <textarea name="" id="" cols={30} rows={10} placeholder="Write about your expereince"></textarea>
