    ...
    <>
      ...
      <div className={styles.privacy_policy}>
        <div className={styles.privacy_policy__content}>
          ...
          <p>This Privacy Policy governs how we collect, use, maintain and disclose information collected from users. Please read our privacy policy carefully to get a clear understanding. This privacy policy applies to the Site and all products and services offered by us.</p>


          <h3>What personal information do we collect?</h3>
          <p>When registering on our site, you may be asked to provide your name and email address or other information to help you with your experience.</p>
          ...
          <p>
            ...
            -To run survey, promotion, etc<br />
          ...
          <h3>Contact</h3>
          <p>If you have any queries regarding the Privacy policy or any other dealings with this site, please feel free to contact us at <a href="mailto:onesearchteam@gmail.com">onesearchteam@gmail.com</a>.</p>
